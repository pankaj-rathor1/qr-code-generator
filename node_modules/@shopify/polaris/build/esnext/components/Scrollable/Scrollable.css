...
.Polaris-Scrollable_1ed9o:focus { outline: var(--p-border-width-050) solid var(--p-color-border-focus); outline-offset: var(--p-space-050); }
...
.Polaris-Scrollable--scrollbarWidthThin_b8ha9 { scrollbar-width: thin; }

.Polaris-Scrollable--scrollbarWidthNone_1c7l0 { scrollbar-width: none; }

.Polaris-Scrollable--scrollbarGutterStable_17mam { scrollbar-gutter: stable; }

.Polaris-Scrollable__scrollbarGutterStableboth--edges_133rp { scrollbar-gutter: stable both-edges; }
