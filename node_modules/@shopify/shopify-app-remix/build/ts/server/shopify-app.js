...
var token_exchange_1 = require("./authenticate/admin/strategies/token-exchange");
var idempotent_promise_handler_1 = require("./authenticate/helpers/idempotent-promise-handler");
var authenticate_3 = require("./authenticate/flow/authenticate");
/**
...
function shopifyApp(appConfig) {
    ...
    var authStrategy = (0, authenticate_1.authStrategyFactory)(tslib_1.__assign(tslib_1.__assign({}, params), { strategy: config.future.unstable_newEmbeddedAuthStrategy && config.isEmbeddedApp
            ? new token_exchange_1.TokenExchangeStrategy(params)
            : new auth_code_flow_1.AuthCodeFlowStrategy(params) }));
    var shopify = {
        ...
        authenticate: {
            admin: authStrategy,
            flow: (0, authenticate_3.authenticateFlowFactory)(params),
...
function deriveApi(appConfig) {
    ...
    return (0, shopify_api_1.shopifyApi)(tslib_1.__assign(tslib_1.__assign({}, appConfig), { hostName: appUrl.host, hostScheme: appUrl.protocol.replace(':', ''), userAgentPrefix: userAgentPrefix, isEmbeddedApp: (_a = appConfig.isEmbeddedApp) !== null && _a !== void 0 ? _a : true, apiVersion: (_b = appConfig.apiVersion) !== null && _b !== void 0 ? _b : shopify_api_1.LATEST_API_VERSION, isCustomStoreApp: appConfig.distribution === types_1.AppDistribution.ShopifyAdmin, future: {
            v10_lineItemBilling: (_c = appConfig.future) === null || _c === void 0 ? void 0 : _c.v3_lineItemBilling,
        } }));
}
function deriveConfig(appConfig, apiConfig) {
    ...
    return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, appConfig), apiConfig), { idempotentPromiseHandler: new idempotent_promise_handler_1.IdempotentPromiseHandler(), canUseLoginForm: appConfig.distribution !== types_1.AppDistribution.ShopifyAdmin, useOnlineTokens: (_b = appConfig.useOnlineTokens) !== null && _b !== void 0 ? _b : false, hooks: (_c = appConfig.hooks) !== null && _c !== void 0 ? _c : {}, sessionStorage: appConfig.sessionStorage, future: (_d = appConfig.future) !== null && _d !== void 0 ? _d : {}, auth: {
            path: authPathPrefix,
