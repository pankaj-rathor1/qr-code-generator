...
function loginFactory(params) {
    ...
    return function login(request) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var url, shopParam, shop, _a, shopWithoutProtocol, shopWithDomain, sanitizedShop, authPath, adminPath, installPath, shouldInstall, redirectUrl;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        authPath = "".concat(config.appUrl).concat(config.auth.path, "?shop=").concat(sanitizedShop);
                        adminPath = api.utils.legacyUrlToShopAdminUrl(sanitizedShop);
                        installPath = "https://".concat(adminPath, "/oauth/install?client_id=").concat(config.apiKey);
                        shouldInstall = config.isEmbeddedApp && config.future.unstable_newEmbeddedAuthStrategy;
                        redirectUrl = shouldInstall ? installPath : authPath;
