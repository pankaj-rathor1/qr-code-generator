...
var AuthCodeFlowStrategy = /** @class */ (function () {
    ...
    AuthCodeFlowStrategy.prototype.authenticate = function (request, sessionContext) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, api, config, logger, shop, session;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this, api = _a.api, config = _a.config, logger = _a.logger;
                        shop = sessionContext.shop, session = sessionContext.session;
    ...
    AuthCodeFlowStrategy.prototype.handleClientError = function (request) {
        var _this = this;
        var _a = this, api = _a.api, config = _a.config, logger = _a.logger;
        return (0, helpers_1.handleClientErrorFactory)({
            request: request,
            onError: function (_a) {
                    ...
                    return tslib_1.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, (0, helpers_1.redirectToAuthPage)({ api: api, config: config, logger: logger }, request, session.shop)];
                            case 1: throw _b.sent();
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        _c.sent();
                        _c.label = 5;
                    case 5: return [4 /*yield*/, (0, helpers_1.triggerAfterAuthHook)({ api: api, config: config, logger: logger }, session, request, this)];
                    case 6:
                        _c.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, client.request("#graphql\n      query shopifyAppShopName {\n        shop {\n          name\n        }\n      }\n    ")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
