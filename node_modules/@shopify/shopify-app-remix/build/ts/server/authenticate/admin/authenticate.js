...
function authStrategyFactory(_a) {
    ...
    function createContext(request, session, authStrategy, sessionToken) {
        var context = {
            admin: (0, helpers_2.createAdminApiContext)(session, params, authStrategy.handleClientError(request)),
            billing: {
                require: (0, billing_1.requireBillingFactory)(params, request, session),
                check: (0, billing_1.checkBillingFactory)(params, request, session),
    ...
    return function authenticateAdmin(request) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, payload, shop, sessionId, sessionToken, existingSession, _b, session, errorOrResponse_1;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        _a = _c.sent(), payload = _a.payload, shop = _a.shop, sessionId = _a.sessionId, sessionToken = _a.sessionToken;
                    ...
                    case 10:
                        existingSession = _b;
                        return [4 /*yield*/, strategy.authenticate(request, {
                    ...
                    case 11:
                        ...
                        return [2 /*return*/, createContext(request, session, strategy, payload)];
                    case 12:
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, { shop: shop_1, payload: payload, sessionId: sessionId_1, sessionToken: sessionToken }];
                case 2:
                    url = new URL(request.url);
                ...
                case 3:
                    sessionId = _a.sent();
                    return [2 /*return*/, { shop: shop, sessionId: sessionId, payload: undefined, sessionToken: sessionToken }];
            }
        });
    });
}
