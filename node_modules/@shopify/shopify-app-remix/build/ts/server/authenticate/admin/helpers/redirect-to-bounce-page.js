...
var redirectToBouncePage = function (params, url) {
    ...
    searchParams.set('shopify-reload', "".concat(config.appUrl).concat(url.pathname, "?").concat(searchParams.toString()));
    ...
    throw (0, server_runtime_1.redirect)("".concat(config.auth.patchSessionTokenPath, "?").concat(searchParams.toString()));
};
