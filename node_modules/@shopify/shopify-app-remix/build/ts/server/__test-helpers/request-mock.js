            ...
            switch (_b.label) {
                ...
                case 1: return [2 /*return*/, (_a.body = _b.sent(),
                        _a.init = {
                            ...
                            url: response.url,
                            headers: tslib_1.__assign(tslib_1.__assign({}, Object.fromEntries(response.headers.entries())), { 'content-type': 'application/json' }),
                        },
                        _a)];
            }
        });
...
function validateMocks() {
    var _a;
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var matchedRequests, _loop_1, _b, _c, _d, index, requestMock, e_2_1;
        var e_2, _e;
            ...
            switch (_f.label) {
                case 0:
                    ...
                    _loop_1 = function (index, requestMock) {
                        var request, _g, url, init, expected, actual, bodyBuffer, bodyString;
                        return tslib_1.__generator(this, function (_h) {
                            switch (_h.label) {
                                case 0:
                                    ...
                                    matchedRequests++;
                                    _g = tslib_1.__read(jest_fetch_mock_1.default.mock.calls[index], 2), url = _g[0], init = _g[1];
                                    expected = {};
                                    actual = {};
                                    ...
                                    if (!(request === null || request === void 0 ? void 0 : request.body)) return [3 /*break*/, 2];
                                    return [4 /*yield*/, stream2buffer(request.body)];
                                case 1:
                                    bodyBuffer = _h.sent();
                                    bodyString = new TextDecoder('utf-8').decode(bodyBuffer);
                ...
                case 1:
                    ...
                    _b = tslib_1.__values(requestMocks.entries()), _c = _b.next();
                    _f.label = 2;
                case 2:
                    if (!!_c.done) return [3 /*break*/, 5];
                    _d = tslib_1.__read(_c.value, 2), index = _d[0], requestMock = _d[1];
                    return [5 /*yield**/, _loop_1(index, requestMock)];
                case 3:
                    _f.sent();
                    _f.label = 4;
                case 4:
...
function stream2buffer(stream) {
    var _a, e_3, _b, _c;
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var buffers, _d, _e, _f, data, e_3_1;
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    _d = true, _e = tslib_1.__asyncValues(stream);
                    _g.label = 2;
                ...
                case 12: return [2 /*return*/, Buffer.concat(buffers)];
            }
        });
    });
}
